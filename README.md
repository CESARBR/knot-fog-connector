...
#### [KNoT-Cloud](https://github.com/CESARBR/knot-cloud-websocket)

* `cloud` **Object**
  * `hostname` **String** cloud host ip
...
* `cloud` **Object**
  * `iota` **String** cloud host ip
    * `hostname` **Number** service entry point
    * `port` **Number** service entry point
  * `orion` **String** description
